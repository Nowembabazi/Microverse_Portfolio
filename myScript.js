...
const projectDetail = [{
  ...
  popDescription:'A daily selection of privately personalized reads; no accounts or sign-ups required.',
  technologies: ['html', 'css', 'javascript'],
  popupTech: ['html', 'css', 'javaScript', 'github', 'Ruby', 'Bootstrap'],
  imageDesk: 'images/IMG-20220826-WA0008.jpg',
  imageDeskPopup: 'images/IMG-20220826-WA0008.jpg',
},
{
  ...
  popDescription:'Experimental content creation feature that allows users to add to an existing story over the course of a day without spamming their friends.',
  technologies: ['html', 'Ruby on rails', 'css', 'javascript'],
  popupTech: ['html', 'css', 'javaScript', 'github', 'Ruby', 'Bootstrap'],
  imageDesk: 'images/snapshot4.svg',
  imageDeskPopup: 'images/snapshot4.svg',
},
{
  title: 'Facebook 360',
  exprience: ['FACEBOOK', 'Back End Dev', '2015'],
  ...
  popDescription:'Exploring the future of media in Facebook first Virtual Reality app; a place to discover and enjoy 360 photos and videos on Gear VR.',
  technologies: ['html', 'Ruby on rails', 'css', 'javascript'],
  popupTech: ['html', 'css', 'javaScript', 'github', 'Ruby', 'Bootstrap'],
  imageDesk: 'images/Snapshootportfolio.svg',
  imageDeskPopup: 'images/Snapshootportfolio.svg',
},
{
  ...
  technologies: ['html', 'Ruby on rails', 'css', 'javascript'],
  popupTech: ['html', 'css', 'javaScript', 'github', 'Ruby', 'Bootstrap'],
  imageDesk:'images/SnapshootPortfolios.svg',
  imageDeskPopup: 'images/SnapshootPortfolios.svg',
},
];
...
for (let i = 0; i < projectDetail.length; i += 1) {
  ...
  for (let k = 0; k < projectDetail[i].exprience.length; k += 1) {
    ...
    if (k !== projectDetail[i].exprience.length - 1) experienceList += '<li><a href="#"><img src="" alt=""></a></li>';
  }
  document.querySelector('#portfolio').innerHTML += `<div class="main-container">
  <div class="grid-item" id="work-1">
    <div class="desk-item1"><img src="${projectDetail[i].imageDesk}" alt=""></div>
     <div class="desk-col">
